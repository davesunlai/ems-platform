...
- **Posun času táhnutím + datum** (v0.11.0): grafy (zařízení i souhrn lokality) lze táhnout doleva/doprava a posouvat se v čase; nad grafem je čitelný popisek datum/čas rozsahu a tlačítko „→ teď".
