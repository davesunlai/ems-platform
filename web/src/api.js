...
export const api = {
  ...
  getPrefs: () => request("/api/auth/me/prefs"),
  setPrefs: (prefs) => request("/api/auth/me/prefs", { method: "PUT", body: prefs }),
  ...
  saveRole: (name, body) => request(`/api/admin/roles/${encodeURIComponent(name)}`, { method: "PUT", body }),
  createRole: (body) => request("/api/admin/roles", { method: "POST", body }),
  deleteRole: (name) => request(`/api/admin/roles/${encodeURIComponent(name)}`, { method: "DELETE" }),
  ...
  emsboxUpdateAgent: (id) => request(`/api/emsboxes/${id}/update-agent`, { method: "POST" }),
  emsboxActions: (id) => request(`/api/emsboxes/${id}/actions`),
  ...
  alertRules: (locId) => request(`/api/localities/${locId}/alert-rules`),
  alertRuleCreate: (locId, body) => request(`/api/localities/${locId}/alert-rules`, { method: "POST", body }),
  alertRuleUpdate: (id, body) => request(`/api/alert-rules/${id}`, { method: "PUT", body }),
  alertRuleDelete: (id) => request(`/api/alert-rules/${id}`, { method: "DELETE" }),
  ...
  setUserNotify: (id, user_id, payload) => request(`/api/admin/localities/${id}/users/${user_id}/notify`, { method: "PUT", body: payload }),
