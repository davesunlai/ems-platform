...
export default function Tour({ open, onClose }) {
  ...
  const steps = [
    ...
    has("control") && { title: "Spínané spotřebiče", route: "/control",
      body: "V Řízení u každé lokality: spínače/relé (eWeLink nebo kontakt střídače), které samy zapnou spotřebič (bojler, spirálu…) podle SoC baterie nebo přebytku z FVE." },
    ...
    has("admin") && { title: "Zúčtovací období", route: "/localities",
      body: "Nastavení zúčtovacího období (začátek, délka, limit přetoků, ceny) je v editaci lokality. Měsíční souhrn a stav přetoků vidíš na dashboardu dole." },
